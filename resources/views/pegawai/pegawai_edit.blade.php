...
<div class="col-md-6 col-md-offset-3" style="padding:2%;">
    {{method_field('PATCH')}}
      ...
      <div class="form-group">
         ...
         <input type="text" class="form-control" value="{{$pegawai->nama_pegawai}}" name="nama_pegawai" id="nama_pegawai" required>
      </div>
      <div class="form-group">
        <label for="status">NIP</label>
        <input type="text" class="form-control" value="{{$pegawai->nip}}" name="nip" id="nip">
